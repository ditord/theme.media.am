...
$plain_post_block_display_category = media_am_get_post_display_category(get_the_ID(), $plain_post_block_category);
if ($plain_post_block_display_category instanceof WP_Term) {
    $plain_post_block_category_name = $plain_post_block_display_category->name;
    $plain_post_block_category_link = get_term_link($plain_post_block_display_category);
}
