			...
			jQuery(document).ready(function() {
				...
				<?php if(!empty(get_option('ald_wrapper_class'))):?>
					...
					$("#loadMore").on('click', function (e) {
						e.preventDefault();
						$("<?php echo esc_attr( get_option('ald_load_class') ); ?>:hidden").slice(0, <?php echo esc_attr( get_option('ald_item_load') ); ?>).fadeIn();
				...
				<?php if(!empty(get_option('ald_wrapper_classa'))):?>
					...
					$("#loadMorea").on('click', function (e) {
						e.preventDefault();
						$("<?php echo esc_attr( get_option('ald_load_classa') ); ?>:hidden").slice(0, <?php echo esc_attr( get_option('ald_item_loada') ); ?>).fadeIn();
				...
				<?php if(!empty(get_option('ald_wrapper_classb'))):?>
					...
					$("#loadMoreb").on('click', function (e) {
						e.preventDefault();
						$("<?php echo esc_attr( get_option('ald_load_classb') ); ?>:hidden").slice(0, <?php echo esc_attr( get_option('ald_item_loadb') ); ?>).fadeIn();
				...
				<?php if(!empty(get_option('ald_wrapper_classc'))):?>
					...
					$("#loadMorec").on('click', function (e) {
						e.preventDefault();
						$("<?php echo esc_attr( get_option('ald_load_classc') ); ?>:hidden").slice(0, <?php echo esc_attr( get_option('ald_item_loadc') ); ?>).fadeIn();
				...
				<?php if(!empty(get_option('ald_wrapper_classd'))):?>
					...
					$("#loadMored").on('click', function (e) {
						e.preventDefault();
						$("<?php echo esc_attr( get_option('ald_load_classd') ); ?>:hidden").slice(0, <?php echo esc_attr( get_option('ald_item_loadd') ); ?>).fadeIn();
